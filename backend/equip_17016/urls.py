...
admin.site.site_header = "EQUIP"
admin.site.site_title = "EQUIP Admin Portal"
admin.site.index_title = "EQUIP Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="EQUIP API",
        default_version="v1",
        description="API documentation for EQUIP App",
    ),
    public=True,
